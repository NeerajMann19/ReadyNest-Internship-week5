    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6">
      ...
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-2xl p-8 relative shadow-2xl space-y-6">
        ...
        <div className="text-center space-y-2">
          <div className="w-12 h-12 bg-gradient-to-tr from-cyan-500 to-blue-500 rounded-xl flex items-center justify-center text-white font-black text-xl mx-auto tracking-tight shadow-lg shadow-cyan-500/25">
            PIQ
          </div>
          <h1 className="text-2xl font-bold tracking-tight text-white mt-4">Welcome back to Prism IQ</h1>
          <p className="text-xs text-slate-400 font-medium">
            Data intelligence and emotional AI chatbot assistant
          </p>
        </div>
